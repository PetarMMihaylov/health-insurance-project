...
public class PolicyInit implements ApplicationRunner {
    ...
    private static final BigDecimal POLICY_PRICE_COMFORT = BigDecimal.valueOf(100);
    private static final BigDecimal POLICY_PRICE_STANDARD = BigDecimal.valueOf(200);
    private static final BigDecimal POLICY_PRICE_LUX = BigDecimal.valueOf(300);
